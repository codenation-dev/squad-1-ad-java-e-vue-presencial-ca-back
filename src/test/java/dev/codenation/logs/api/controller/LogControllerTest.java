...
public class LogControllerTest {
    ...
    @Test
    public void WhenSaveNewLog_ThenReturnSuccess() throws Exception {
    ...
    @Test
    public void WhenFindByExistentId_ThenReturnSuccess() throws Exception {
    ...
    @Test
    public void WhenDeleteByExistentId_ThenReturnSuccess() throws Exception {
        UUID user_id = UUID.randomUUID();
        User user = userUtil.createUser();
        user.setId(user_id);
    ...
    @Test
    public void WhenFindAll_ThenReturnSuccess() throws Exception {
        UUID user_id = UUID.randomUUID();
        User user = userUtil.createUser();
        user.setId(user_id);
        ...
        logDTO1.setSeverity(Severity.ERROR);
        String result = mvc.perform(post("/logs")
                .header("Authorization", "Bearer " + this.token)
                .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
        ...
        logDTO2.setSeverity(Severity.FATAL);
        ...
        logDTO3.setSeverity(Severity.WARNING);
        result = mvc.perform(post("/logs")
                .header("Authorization", "Bearer " + this.token)
                .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE)
